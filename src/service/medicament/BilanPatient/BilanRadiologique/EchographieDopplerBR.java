...
public final class EchographieDopplerBR extends Parent{
   ...
   final String DateInsBilan;
    public EchographieDopplerBR(int TypeCCP,String NumDossier,String DateInsBilan) throws SQLException{
    ...
    vbMod.getChildren().addAll(IndModifS,hperAnnul);
        ...
        final Label DateBilan                     = new Label("Date Echographie Doppler ");  
        ...
        final Label         EchographieDoppler                 = new Label("Echographie doppler ");
        EchographieDoppler.getStyleClass().add("setStylesousParteBilan");
              final RadioButton       OuiEchoDopp                 = new RadioButton("Oui");OuiEchoDopp.setUserData("Oui");OuiEchoDopp.setSelected(true);
              final RadioButton       NonEchoDopp                 = new RadioButton("Non");NonEchoDopp.setUserData("Non");
              
              OuiEchoDopp.setToggleGroup(Tgroup1); NonEchoDopp.setToggleGroup(Tgroup1);
        grid.add(EchographieDoppler,0,0); grid.add(OuiEchoDopp,1,0); grid.add(NonEchoDopp,2,0);
    ...
    final DropShadow shadow  = new DropShadow();
        ...
        Ajouter.setOnAction((ActionEvent)->{
            try {
                ...
                Logger.getLogger(EchographieDopplerBR.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        
        grid.add(Ajouter, 5,13);
        grid.add(IndIns,4,7,4,6);
    ///
    ...
    gridC.setHgap(7);
         ...
         final Label BilanEchoLabel             = new Label("Echographique Doppler :");
    ...
    public LocalDate getDateB() {
     ...
     public int InsertionSGBD(String NumDossier) throws SQLException{
        ...
        int i = bddInsert.AddElement("insert into EchographieDoppler values (0,'"+this.getEchographie()+"','"+this.getFoieReg()+"','"+this.getFoieHom()+"','"+this.getTailleNodule()+"','"+
        this.getNombre()+"','"+
        this.getS1()+" "+this.getS2()+" "+this.getS3()+" "+this.getS4()+" "+this.getS5()+" "+this.getS6()+" "+this.getS7()+" "+this.getS8()+"','"+
        this.getEvahissementVascul()+"','"+this.getSiOui()+"','"+this.getPrecise()+"','"+NumDossier+"','"+this.getDateB()+"')");
 ...
 public void ConsultationE(String NumDossier) throws SQLException{
        ...
        EchographieDopplerClasse  Bilan         = null;
        Consultation bddCons     = new Consultation();
        ResultSet res = bddCons.ExtElement("select * from echographieDoppler where NumDossier = '"+NumDossier+"'"
                                           +"and DateDoppler = '"+DateInsBilan+"'");
    while(res.next()){
     Bilan   = new EchographieDopplerClasse(res.getDate(12),res.getString(2),res.getString(3),res.getString(4),res.getString(5)
    ...
    public int  DeleteSGBD(String NumDossier) throws SQLException{
            ...
            int j = bddDelete.AddElement("delete from EchographieDoppler where NumDossier ='"+NumDossier+"' and dateDoppler ='"+DateInsBilan+"'" );
