...
public final class TDMBR extends Parent{
    ...
    public TDMBR(int TypeCCP,String NumDossier,String DateInsBilan) throws SQLException{
    ...
    vbMod.getChildren().addAll(IndModifS,hperAnnul);
        ...
        final Label DateBilan                     = new Label("Date TDM ");  
        ...
        final Label          TDM        = new Label("TDM"); 
              final RadioButton   OuiTDM          = new RadioButton("Oui");  OuiTDM.setUserData("Oui");
              final RadioButton   NonTDM          = new RadioButton("Non");  NonTDM.setUserData("Non");
              
              OuiTDM.setSelected(true);
              OuiTDM.setToggleGroup(Tgroup1);  NonTDM.setToggleGroup(Tgroup1);
              TDM.getStyleClass().add("setStylesousParteBilan");
        grid.add(TDM,0,0);  grid.add(OuiTDM,1,0); grid.add(NonTDM,2,0);
    ...
    vboxE.getChildren().add(precise);                                            
        ...
        grid.add(whachIn,0,13); grid.add(whachOut,1,13); grid.add(ATYPIQUE,2,13);
           ...
           autreTDM  = champSaisierA();
           autreTDM.setPromptText("Autre");     
           autreTDM.setPrefSize(250,80);
    grid.add(autreTDM,0,14,2,2);
        ...
        Ajouter.setOnMouseExited(new EventHandler<MouseEvent>(){
         ...
         Ajouter.setOnAction((ActionEvent)->{
            try {
                ...
                Logger.getLogger(TDMBR.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
         
        grid.add(Ajouter, 5,16);
        grid.add(IndIns,3,12,3,3);
    ///
    ...
    Toggle new_value)->{
        if(Tgroup1.getSelectedToggle().getUserData().equals("Non")){
            ...
            grid.getChildren().removeAll(Foie,regulièr,irregulier,homgène,hétérogèn,TailleNodules,T1,T2,T3,T4,T5,T6,T7,T8,
                                     ...
                                     whachIn,whachOut,ATYPIQUE,autreTDM,Ajouter);
        }else {
    ...
    gridC.setHgap(7);
         ...
         final Label BilanEchoLabel             = new Label("TDM  :");
         BilanEchoLabel.getStyleClass().add("setStyleCirconsanceDic");                                 gridC.add(BilanEchoLabel, 0,1);
     final Label ConsDateEchographie             = new Label("Date TDM                         :");    gridC.add(ConsDateEchographie, 0,2);      gridC.add(TDateTDM, 5,2);
     final Label ConsEcho                        = new Label("TDM                              :");    gridC.add(ConsEcho, 0,3);                 gridC.add(TTDM, 5,3);
     ...
     final Label ConsEchoLv                      = new Label("Type TDM                         :");    gridC.add(ConsEchoLv, 0,13);              gridC.add(TTypeTDM, 5,13);
    ...
    public String getAutreTDM() {
        return autreTDM.getText();
    }
    ...
    public LocalDate getDateB() {
     ...
     public int  InsertionSGBD(String NumDossier) throws SQLException{
        ...
        int i= bddInsert.AddElement("insert into tdm values (0,'"+this.getTDM()+"','"+this.getFoieReg()+"','"+this.getFoieHom()+"','"+this.getTailleNodule()+"','"+
        this.getNombre()+"','"+
        this.getS1()+" "+this.getS2()+" "+this.getS3()+" "+this.getS4()+" "+this.getS5()+" "+this.getS6()+" "+this.getS7()+" "+this.getS8()+"','"+
        this.getEvahissementVascul()+"','"+this.getSiOui()+"','"+this.getPrecise()+"','"+this.getGanglionnaire()+"','"+
        this.getWach()+"','"+this.getAutreTDM()+"','"+NumDossier+"','"+this.getDateB()+"')");
 ...
 TextArea textA = new TextArea(){
   ...
   return textA;  
    ...
    public void ConsultationE(String NumDossier) throws SQLException{
        ...
        ResultSet res = bddCons.ExtElement("select * from tdm where NumDossier = '"+NumDossier+"'"
                                           +"and Datetdm = '"+DateInsBilan+"'");
    while(res.next()){
    ...
    try{
     ...
     this.setTDMAutres("-----------");   
        ...
        public int  DeleteSGBD(String NumDossier) throws SQLException{
            ...
            int j = bddDelete.AddElement("delete from tdm where NumDossier ='"+NumDossier+"' and datetdm ='"+DateInsBilan+"'" );
